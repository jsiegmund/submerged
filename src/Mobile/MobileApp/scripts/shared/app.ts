namespace Submerged {
    ...
    export class NgApp {
        constructor() {
            ...
            var myapp = angular.module("ngapp", ["ui.router", "ngMdIcons", "ngMaterial", "ngCordova", "ngCordova.plugins", "ngStorage", "angular-jwt", "pr.longpress", "ngCookies", "mdColorPicker", "moment-picker"])
            ...
            if (!myapp)
                console.log("myapp is null");
            else
                console.log("myapp is NOT null");
